...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Jacquard", path: "/about" },
    { label: "Benefits of REACH Jacquard", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    { label: "REACH Jacquard Images", path: "/rmmimages" },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block w-fit">
              <span className="text-primary">REACH</span> Jacquard
            </Link>
            <p className="text-gray-300 max-w-md">
              The Best Jacquard Software that enables you create a wide range of jacquard designs easily.
            </p>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email contact to REACH Tech" className="w-8 icon-a52356" />
              ...
              >
                <img src={whatsappIcon} alt="Whatsapp contact to REACH Tech" className="w-8 icon-a52356" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact form link to REACH Tech" className="w-7 icon-a52356" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
