        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex flex-wrap items-center justify-end gap-5 text-sm sm:text-base">
            ...
            <div className="flex items-center gap-2">
              <img src={emailIcon} alt="Email contact to REACH Tech" className="w-5 sm:w-7 icon-a52356" />
            ...
            >
              <img src={whatsappIcon} alt="Whatsapp contact to REACH Tech" className="w-5 sm:w-7 icon-a52356" />
            ...
            <a
              ...
              className="flex items-center gap-2"
            >
              <img src={contactIcon} alt="Contact form link to REACH Tech" className="w-5 sm:w-7 icon-a52356" />
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <Link to="/" className="text-3xl sm:text-4xl font-bold">
              ...
              <span className="text-black"> Jacqard</span>
            </Link>
